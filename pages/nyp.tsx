...
<section className="flex min-h-[450px] flex-col-reverse md:flex-row-reverse">
  <div className="flex flex-1 items-center justify-center">
    <article className="max-w-md py-24 px-3 text-center md:text-left">
      ...
      <p className="text-xl leading-9 text-black/60">Using  a collaborate formula of designers, researchers, photographers,
videographers, and copywriters, we`ll build and extend your brand in digital places..</p>
  ...
  <div className="bg-glass min-h-[450px] flex-1 bg-yellow-400 bg-center bg-cover bg-no-repeat"></div>
</section>
  ...
  <div className="flex flex-col justify-between md:flex-row gap-12">
    <article className="flex flex-col items-center gap-3 text-center px-2 py-4">
      <div className=" h-24 w-24 overflow-hidden rounded-full outline-dotted outline-4 outline-offset-2 outline-sky-800">
        <img  className="w-full object-cover h-full" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=761&q=80"/>
      </div>
...
<section className="md:flex  flex-wrap grid grid-cols-2">
  <div className="h-[350px] overflow-hidden md:flex-1 w-full bg-blue-800">
    <img className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1559703248-dcaaec9fab78?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80"/>
  </div>
   <div className="h-[350px] overflow-hidden md:flex-1 w-full bg-blue-800">
    <img className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1618897996318-5a901fa6ca71?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80"/>
  </div>
  <div className="h-[350px] overflow-hidden md:flex-1 w-full bg-blue-800">
    <img className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1552089123-2d26226fc2b7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80"/>
  </div>
  <div className="h-[350px] overflow-hidden md:flex-1 w-full bg-blue-800 flex items-center justify-center">
