...
const HomeHero: React.FC = () => {
  return (
    <div className="relative flex items-center justify-center">
      <section className="mt-10 mb-28 flex w-full max-w-[1680px] flex-col items-end px-6 mdlg:px-16 lg:px-32 xl:px-40 2xl:px-48">
      ...
      <div className="absolute -left-10 right-0 -bottom-[61%] hidden h-full w-[200%] dark:block lg:w-[110%]">
        <Image
          src="/img/shapes/rainbow_wave_dark-german.svg"
          layout="fill"
          quality={100}
          draggable={false}
          priority={true}
